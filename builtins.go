...
func installBuiltinFunctions(prelude *Prelude) {
	...
	prelude.Bind("round half down", NewNativeFunc(func(args map[string]any) (any, error) {
		_, hasExtra := args["__extra"]
		nVal, hasN := args["n"]
		scaleVal, hasScale := args["scale"]
		if !hasN || !hasScale || hasExtra {
		...
		return roundHalfDown(n, scale), nil
	}).Optional("n", "scale").Vararg("__extra"))

	prelude.Bind("round half up", NewNativeFunc(func(args map[string]any) (any, error) {
		_, hasExtra := args["__extra"]
		nVal, hasN := args["n"]
		scaleVal, hasScale := args["scale"]
		if !hasN || !hasScale || hasExtra {
	...
	prelude.Bind("round down", NewNativeFunc(func(args map[string]any) (any, error) {
		_, hasExtra := args["__extra"]
		nVal, hasN := args["n"]
		scaleVal, hasScale := args["scale"]
		if !hasN || !hasScale || hasExtra {
